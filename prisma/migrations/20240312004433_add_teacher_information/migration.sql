...
-- AlterTable
ALTER TABLE "studentRecord" ADD COLUMN     "primaryTeacherAge" TEXT,
ADD COLUMN     "primaryTeacherEducation" TEXT,
ADD COLUMN     "primaryTeacherName" TEXT,
ADD COLUMN     "primaryTeacherProfile" TEXT,
ADD COLUMN     "primaryTeacherRelationship" TEXT;
