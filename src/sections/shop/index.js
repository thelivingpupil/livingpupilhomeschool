      ...
      {disableShop ? (
        <div className="flex flex-col items-center justify-center h-screen p-5 m-auto space-y-5 md:w-1/2">
          ...
          <p className="text-center">
            We regret to inform you that our shop is temporarily closed today due to maintenance. We apologize for any inconvenience caused. We will reopen promptly at 5 PM tomorrow, July 3rd. Thank you for your understanding and continued support.
          </p>
        </div>
      ) : (
        <>
          ...
          <section className="px-5 py-10 md:px-0">
            <div className="container flex flex-col mx-auto space-y-10 md:flex-row md:space-y-0 md:space-x-10">
                ...
                <div className="flex space-x-5 space-between">
                  ...
                  <div className="relative inline-block w-1/2 border rounded">
                    ...
                    >
                      ...
                      <option value="homeschoolBundles">Bundles</option>
                      <option value="homeschoolModules">Modules</option>
                      <option value="homeschoolDigitalDownloads">
                        Digital Downloads
                      </option>
                      <option value="homeschoolEnrichment">Enrichment</option>
                      <option value="homeschoolSupplies">Supplies</option>
                      <option value="elearning">E-Learning</option>
                      <option value="studentPortfolio">Student Portfolio</option>
                    </select>
                    <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none">
                      <ChevronDownIcon className="w-5 h-5" />
                    </div>
                  ...
                  {isLoading ? (
                    <>
                      {[...Array(10).keys()].map((index) => (
                        <div
                          key={index}
                          className="relative flex flex-col space-y-3 animate-pulse"
                        >
                          <div className="object-cover w-full h-40 bg-gray-300 rounded-lg" />
                          <div className="w-full h-5 bg-gray-300 rounded-lg" />
                          <div className="w-1/2 h-5 bg-gray-300 rounded-lg" />
                        </div>
                      ))}
                    </>
                  ) : (
                      ...
                      {items.length ? (
                        items.map((props) => (
                          <ShopItem
                            key={props.id}
                            {...props}
                            addToCart={() => addToCart(props)}
                          />
                        ))
                      ) : (
                        <p className="py-3 text-center">No Items Available</p>
                      )}
                    </>
                  )}
                </div>
              ...
              <div className="hidden md:block md:w-1/3">
                <div className="px-5 py-3 border-4 space-y-5 rounded-lg border-primary-500">
                  <div className="flex flex-col text-sm">
                    <div>Please select a shipping area:</div>
                    <div className="relative inline-block w-full rounded border">
                      <select
