const BlogContent = ({ title, description, resource }) => {
  return (
    <section className="body-font bg-blog">
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex w-full mb-20 space-x-10">
            <div className="w-full mb-6 lg:w-1/3 lg:mb-0">
              <h2 className="mb-2 text-2xl font-medium text-primary-600 sm:text-3xl title-font font-display">
                {title}
              </h2>
              <div className="w-20 h-1 rounded bg-secondary-600"></div>
            </div>
            <p className="w-full leading-relaxed lg:w-2/3">{description}</p>
          </div>
