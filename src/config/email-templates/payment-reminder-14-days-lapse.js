...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;">
		<tbody>
			<tr>
				<td>
					<table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e2edf7; padding-top: 20px;">
						<tbody>
							<tr>
								<td>
					...
					<table class="row row-4" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e2edf7;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff; border-radius: 0; color: #000000; width: 600px; margin:  auto; padding: 20px 20px" width="600">
										<tbody>
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="paragraph_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad">
																<div style="color:#000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:20px;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">Hello <strong>${parentName}</strong>,</p>
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">&nbsp;</p>
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">This is an automated reminder that your tuition fee payment of <strong>₱${amount}</strong> for ${studentFirstName} is <strong>14 DAYS</strong> <strong>OVERDUE.</strong></p>
																	
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">Please settle the amount as soon as possible to avoid delays in processing <strong>${studentFirstName} ${studentLastName}</strong>’s year-end requirements.</p>
																	
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">Amount to be paid as well as the payment link can be found when you click <strong>School Fees</strong> in your LPH Parent Portal under the “Student Record” menu or by clicking the "Payment Link" button below.</p>
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">If payment has already been made, please disregard this reminder. If you have concerns about your school fees, please feel free to send a message to finance.livingpupil@gmail.com.</p>
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">&nbsp;</p>
																	<table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
																		<tr>
																			<td align="center">
																				<a href="${url}" target="_blank" style="background-color: #fac84f; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">Payment Link</a>
																				<a href="https://livingpupilhomeschool.com/account" target="_blank" style="background-color: #2e3494; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-family: Arial, Helvetica, sans-serif; font-size: 16px; margin: 0 15px ;">Parent Portal</a>
																			</td>
																		</tr>
																	</table>
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">&nbsp;</p>
																	<p style="margin: 0; color:#000;">Thank you!</p>
																</div>
															</td>
														</tr>
													</table>
								...
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff; border-radius: 0; color: #000000; width: 600px; margin: 0 auto;" width="600">
										<tbody>
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<div class="spacer_block block-1" style="height:30px;line-height:60px;font-size:1px;">&#8202;</div>
												</td>
											</tr>
										</tbody>
									</table>
...
const text = ({ parentName }) => {
	return `
Welcome! You are logging in with ${parentName}
