...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;">
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">We are pleased to inform you that the requested documents for <strong>${studentFullName}</strong> are now ready for pick-up. The documents include the following:</p>
                                                                    <ul>
        ${document.map(doc => {
        ...
        return `<li>${detail ? detail.label : `Unknown Document: ${doc.docName}`}</li>`;
                                                                    ...
                                                                    <p style="margin-top: 20px; margin-bottom: 16px;">You may collect the documents at our office during our operating hours:</p>
                                                                    <p style="margin-top: 20px; margin-bottom: 4px;">Monday-Friday</p>
                                                                    <p style="margin-top: 4px; margin-bottom: 16px;">8am-5pm</p>
                                                                    <p style="margin-top: 20px; margin-bottom: 16px;">Kindly confirm your preferred date and time for pick-up to ensure that we can prepare for your visit.</p>
