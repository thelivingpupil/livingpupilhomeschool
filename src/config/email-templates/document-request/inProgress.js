...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;">
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">We would like to inform you that the processing of your requested documents for <strong>${studentFullName}</strong> is currently underway. The documents you requested are as follows:</p>
                                                                    <ul>
        ${document.map(doc => {
        ...
        return `<li>${detail ? detail.label : `Unknown Document: ${doc.docName}`}</li>`;
                                                                    ...
                                                                    <p style="margin-top: 20px; margin-bottom: 16px;">Rest assured, we are diligently working to complete your request as quickly as possible. We will notify you once the documents are ready for release. </p>
                                                                    <p style="margin: 0; margin-bottom: 16px;">Should you have any questions or additional concerns, please feel free to reach out to us.</p>
                                                                    <p style="margin: 0; margin-bottom: 16px;">Thank you for your patience and understanding. </p>
