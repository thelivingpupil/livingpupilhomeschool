                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">Thank you for your response and for confirming the receipt of the documents for <strong>${studentFullName}</strong>. We are glad to know that everything has arrived safely.</p>
                                                                    <p style="margin-top: 20px; margin-bottom: 16px;">Should you need any further assistance or have any additional requests, please feel free to reach out. We are always here to help.</p>
                                                                    <p style="margin: 0; margin-bottom: 16px;">Thank you once again for your cooperation.</p>
