...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;">
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">We hope this message finds you well. We are reaching out to confirm if you have received the documents sent for <strong>${studentFullName}</strong>. The documents include the following:</p>
                                                                    <ul>
        ${document.map(doc => {
        ...
        return `<li>${detail ? detail.label : `Unknown Document: ${doc.docName}`}</li>`;
                                                                    ...
                                                                    <p style="margin-top: 20px; margin-bottom: 16px;"><strong>If you have received the package, we kindly ask you to confirm by replying to this email.</strong></p>
                                                                    <p style="margin-top: 20px; margin-bottom: 16px;">Should there be any issues or concerns with the delivery, please do not hesitate to let us know so we can assist you promptly.</p>
                                                                    <p style="margin: 0; margin-bottom: 16px;">Thank you for your attention, and we look forward to your response.</p>
