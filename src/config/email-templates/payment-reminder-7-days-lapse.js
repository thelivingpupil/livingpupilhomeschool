														...
														<tr>
															<td class="pad">
																<div style="color:#000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:20px;text-align:left;mso-line-height-alt:19.2px;">
																	...
																	<p style="margin: 0; margin-bottom: 16px; color:#000;">This is an automated reminder that your tuition fee payment of <strong>₱${amount}</strong> for ${studentFirstName} is <strong>7 DAYS</strong> <strong>OVERDUE.</strong></p>
