																...
																<div style="color:#000;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    ...
                                                                    <table class="details-table" style="border-collapse: collapse;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding: 5px; text-align: left;">₱${shipping.toFixed(2)}</td>
                                                                        </tr>
																		<tr>
                                                                            <td style="padding: 5px; text-align: left;">Subtotal:</td>
                                                                            <td style="padding: 5px; text-align: left;">₱${subTotal.toFixed(2)}</td>
                                                                        </tr>
																		<tr>
                                                                            <td style="padding: 5px; text-align: left;">Installment Fee:</td>
                                                                            <td style="padding: 5px; text-align: left;">₱${installment.toFixed(2)}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding: 5px; text-align: left;"><strong>Total:</strong></td>
                                                                            <td style="padding: 5px; text-align: left;"><strong>₱${total.toFixed(2)}</strong></td>
                                                                        </tr>
                                                                    </table>
                                                                    <hr style="margin: 0; margin-bottom: 16px;">
																	<p style="margin: 0; margin-bottom: 15px;"><strong>Payment Schedules</strong></p>
																	<table class="details-table" style="border-collapse: collapse;">
																		<tr>
                                                                            <td style="padding: 5px; text-align: left;">
																				${new Date(getOrderFeeDeadline(0, paymentType, orderDate)).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}:
																			</td>
                                                                            <td style="padding: 5px; text-align: left;">₱${installment.toFixed(2)}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding: 5px; text-align: left;">
																				${new Date(getOrderFeeDeadline(1, paymentType, orderDate)).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}:
																			</td>
                                                                            <td style="padding: 5px; text-align: left;">₱${installment.toFixed(2)}</td>
                                                                        </tr>
																		<tr>
                                                                            <td style="padding: 5px; text-align: left;">
																				${new Date(getOrderFeeDeadline(2, paymentType, orderDate)).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}:
																			</td>
                                                                            <td style="padding: 5px; text-align: left;">₱${installment.toFixed(2)}</td>
                                                                        </tr>
																		<tr>
                                                                            <td style="padding: 5px; text-align: left;">
																				${new Date(getOrderFeeDeadline(3, paymentType, orderDate)).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}:
																			</td>
                                                                            <<td style="padding: 5px; text-align: left;">₱${installment.toFixed(2)}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding: 5px; text-align: left;">
																				${new Date(getOrderFeeDeadline(4, paymentType, orderDate)).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}:
																			</td>
                                                                            <td style="padding: 5px; text-align: left;">₱${installment.toFixed(2)}</td>
                                                                        </tr>
                                                                    </table>
