														...
														<tr>
															<td class="pad">
																<div style="direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:14.399999999999999px;">
																	<p style="margin: 0; margin-bottom: 3px; color:#ffffff;">Hi ${email},</p>
																	...
																	<p style="margin: 0; margin-bottom: 3px; color:#ffffff;">Birth Certificate: ${birthCertificateLink}</p>
																	<p style="margin: 0; margin-bottom: 3px; color:#ffffff;">Report Card / School Card: ${reportCardLink}</p>
																	<p style="margin: 0; margin-bottom: 3px;">&nbsp;</p>
																	...
																	<p style="margin: 0; margin-bottom: 3px;">&nbsp;</p>
																	<p style="margin: 0; margin-bottom: 3px; color:#ffffff;">Payment URL: <a href="${schoolFeeUrl}" target="_blank"><strong>Payment URL</strong></a></p>
																	<p style="margin: 0; margin-bottom: 3px;">&nbsp;</p>
