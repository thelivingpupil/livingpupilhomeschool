                                ...
                                <div class="mt-6 flex items-center justify-between">
                                    <div className="flex items-center space-x-5">
                                        ...
                                        {documentRequest && documentRequest?.transaction && (
                                            <span
                                                className={`rounded-full py-0.5 text-sm px-2 text-center ${STATUS_BG_COLOR[documentRequest?.transaction.paymentStatus]
                                                    }`}
                                            >
                        ...
                        {documentRequest?.transaction?.paymentProofLink && (
                            <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <span className={`text-xs px-2 py-1 rounded-full text-center ${STATUS_BG_COLOR[documentRequest?.transaction?.paymentStatus] || 'bg-gray-200'}`}>
                        ...
                        <div className="mt-4 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                            <div className="text-center">
                                ...
                                <div className="mt-2 text-xs text-gray-500">
                                    ...
                                    {!process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY && ' (No site key configured)'}
                                </div>
                            </div>
                        </div>
                    </div>
