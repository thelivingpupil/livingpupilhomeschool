...
import { html, text } from '@/config/email-templates/payment-reminder-7-days-lapse';
            ...
            if (feeOrder0 && feeOrder0.transaction) {
                ...
                for (const fee of studentRecord.student?.schoolFees || []) {
                    ...
                    if (deadlineStr) {
                        ...
                        const daysLapsed = Math.floor((today - deadline) / (1000 * 60 * 60 * 24));
                        ...
                        if (daysLapsed === 7) {
                            ...
                            await sendMail({
                                ...
                                subject: `[Living Pupil Homeschool] Payment Reminder 7 Days Lapse`,
                                text: text({
                                    parentName,
                                    studentFirstName,
                                }),
