...
/** Legacy dashboard: workspace cards, invitations, create-student modal. See `/account` for the students-first list. */
    ...
    <AccountLayout>
      ...
      >
        <div className="space-y-0 text-sm text-gray-600">
          <p>
            Create a student entry to keep your student&apos;s records in one
            place.
          </p>
      ...
      >
        <p>
          Thank you for your support during the 2024-2025 school year. We greatly
          appreciate your involvement and commitment to your child&apos;s
